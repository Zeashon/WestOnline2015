...
$(document).ready(function() {
	$.fn.fullpage({
		slidesColor: ['RGB(40,20,31)', 'white', '#7BAABE', 'white'],
		anchors: ['page1', 'page2', 'page3', 'page4'],
		navigation: true,
		navigationPosition: 'right',
		navigationTooltips: ['西二在线', '最近动态', '作品展示', '进入西二'],
		loopBottom:false,
		afterLoad: function(anchorLink, index){
			if(index == 2){
				$('.section2').find('.P2-0').delay(300).animate({
					top: '0'
				}, 1500, 'easeOutExpo');
			}
			if(index == 2){
				$('.section2').find('.P2-1').delay(300).animate({
					right: '0'
				}, 1500, 'easeOutExpo');
			}
			if(index == 2){
				$('.section2').find('.P2-2').delay(300).animate({
					left: '0'
				}, 1500, 'easeOutExpo');
			}
			if(index == 2){
				$('.section2').find('.P2-3').delay(300).animate({
					bottom: '0'
				}, 1500, 'easeOutExpo');
			}
			if(index == 3){
			...
			if(index == 4){
				$('.section4').find('.footer').delay(2200).animate({
					bottom: '0'
				}, 3500, 'easeOutExpo');
			}
			if(index == 4){
				$('.section4').find('.wel').delay(300).animate({
					top: '10%'
				}, 1500, 'easeOutExpo');
			}
			if(index == 4){
				$('.section4').find('.welDown').delay(1200).animate({
					top: '40%'
				}, 1500, 'easeOutExpo');
			}
		},
		onLeave: function(index, direction){
			if(index == 2){
				$('.section2').find('.P2-0').delay(400).animate({
					top: '-120%'
				}, 1500, 'easeOutExpo');
			}
			if(index == 2){
				$('.section2').find('.P2-1').delay(400).animate({
					right: '-120%'
				}, 1500, 'easeOutExpo');
			}
			if(index == 2){
				$('.section2').find('.P2-2').delay(400).animate({
					left: '-120%'
				}, 1500, 'easeOutExpo');
			}
			if(index == 2){
				$('.section2').find('.P2-3').delay(400).animate({
					bottom: '-120%'
				}, 1500, 'easeOutExpo');
			}
			if(index == 3){
			...
			if(index == 4){
				$('.section4').find('.footer').delay(300).animate({
					bottom: '-220px'
				}, 1500, 'easeOutExpo');
			}
			if(index == 4){
			...
			if(index == 4){
				$('.section4').find('.welDown').delay(300).animate({
					top: '240%'
				}, 1500, 'easeOutExpo');
			}
		}
